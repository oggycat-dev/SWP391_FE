/**
 * Dealer Discount Policies Tab Component
 */
...
interface DealerDiscountPoliciesTabProps {
  dealerId: string
  dealerName: string
}

export function DealerDiscountPoliciesTab({ dealerId, dealerName }: DealerDiscountPoliciesTabProps) {
  const { data: policies, isLoading } = useDealerDiscountPolicies({ dealerId })
